...
import { Calendar, User, Pill, DollarSign, FileText } from "lucide-react"
import { getPrescriptionWithDetails } from "@/data/prescription"
...
export function PrescriptionDetailsDialog({ open, onOpenChange, prescriptionId }: PrescriptionDetailsDialogProps) {
  ...
  const prescription = getPrescriptionWithDetails(prescriptionId)
