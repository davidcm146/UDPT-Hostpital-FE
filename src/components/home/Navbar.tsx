...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 px-8 w-full bg-white/80 backdrop-blur-md border-b">
      <div className="container mx-auto px-4 py-3">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center w-full">
            <div className="flex justify-center flex-1 space-x-1 lg:space-x-4">
              <Link
                to="/"
              ...
              <Link
                to="/find-doctor"
                className={`px-3 py-2 rounded-md ${isActive("/find-doctor") ? "text-teal-600 font-medium" : "text-gray-700 hover:text-teal-600"
                  } transition-colors`}
              >
              ...
              <Link
                ...
                className={`px-3 py-2 rounded-md ${isActive("/examination-schedule") || location.pathname.includes("/examination")
              ...
              <Link
                to="/prescriptions"
                className={`px-3 py-2 rounded-md ${isActive("/prescriptions") ? "text-teal-600 font-medium" : "text-gray-700 hover:text-teal-600"
                  } transition-colors`}
              >
                <span className="flex items-center">
            ...
            <Sheet open={isOpen} onOpenChange={setIsOpen}>
              ...
              <SheetContent side="right" className="w-[300px] sm:w-[400px]">
                <nav className="flex flex-col gap-4 mt-8">
                  ...
                  <Link
                    to="/find-doctor"
                    className={`block px-3 py-2 rounded-md ${isActive("/find-doctor")
                  ...
                  <Link
                    to="/examination-schedule"
                    className={`block px-3 py-2 rounded-md ${isActive("/examination-schedule") || location.pathname.includes("/examination")
                        ? "bg-teal-50 text-teal-600 font-medium"
                        : "text-gray-700 hover:bg-gray-100"
                      }`}
                    onClick={() => setIsOpen(false)}
                  ...
                  <Link
                    to="/prescriptions"
                    className={`block px-3 py-2 rounded-md ${isActive("/prescriptions")
                        ? "bg-teal-50 text-teal-600 font-medium"
                        : "text-gray-700 hover:bg-gray-100"
                      }`}
                    onClick={() => setIsOpen(false)}
